...
(defn count-component       [] (r/component :count-cmp count-view "tweet-count" {}))
(defn users-count-component [] (r/component :users-count-cmp users-count-view "users-count" {}))
(defn total-count-component [] (r/component :tt-count-cmp total-count-view "total-tweet-count" {}))
