...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t13505 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t13505 = (function (val,box,meta13506){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t13505.cljs$lang$type = true;
cljs.core.async.impl.channels.t13505.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t13505";
cljs.core.async.impl.channels.t13505.cljs$lang$ctorPrWriter = (function (this__4048__auto__,writer__4049__auto__,opt__4050__auto__){return cljs.core._write.call(null,writer__4049__auto__,"cljs.core.async.impl.channels/t13505");
});
cljs.core.async.impl.channels.t13505.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t13505.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13507){var self__ = this;
var _13507__$1 = this;return self__.meta13506;
});
cljs.core.async.impl.channels.t13505.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13507,meta13506__$1){var self__ = this;
var _13507__$1 = this;return (new cljs.core.async.impl.channels.t13505(self__.val,self__.box,meta13506__$1));
});
cljs.core.async.impl.channels.__GT_t13505 = (function __GT_t13505(val__$1,box__$1,meta13506){return (new cljs.core.async.impl.channels.t13505(val__$1,box__$1,meta13506));
});
}
return (new cljs.core.async.impl.channels.t13505(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_13508 = self__.takes.pop();if((taker_13508 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_13508))
{var take_cb_13509 = cljs.core.async.impl.protocols.commit.call(null,taker_13508);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_13509,taker_13508,this$__$1){
return (function (){return take_cb_13509.call(null,null);
});})(take_cb_13509,taker_13508,this$__$1))
);
} else
{}
{
...
var putter_13510 = self__.puts.pop();if(!((putter_13510 == null)))
{var put_handler_13511 = putter_13510.handler;var val_13512 = putter_13510.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_13511))
{var put_cb_13513 = cljs.core.async.impl.protocols.commit.call(null,put_handler_13511);var __13514__$1 = cljs.core.async.impl.protocols.commit.call(null,handler);cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_13513,__13514__$1,put_handler_13511,val_13512,putter_13510,_,retval,this$__$1){
return (function (){return put_cb_13513.call(null,true);
});})(put_cb_13513,__13514__$1,put_handler_13511,val_13512,putter_13510,_,retval,this$__$1))
);
cljs.core.async.impl.protocols.add_BANG_.call(null,self__.buf,val_13512);
} else
{{
continue;
}
