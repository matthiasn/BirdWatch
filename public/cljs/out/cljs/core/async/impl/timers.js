...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_13408 = 0;while(true){
if((i_13408 < arr.length))
{(arr[i_13408] = null);
{
...
{var i_13415 = (self__.level + 1);while(true){
if((i_13415 <= (new_level + 1)))
{(update[i_13415] = self__.header);
{
var G__13416 = (i_13415 + 1);
i_13415 = G__13416;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_13417 = 0;while(true){
if((i_13417 <= self__.level))
{var links_13418 = (update[i_13417]).forward;if(((links_13418[i_13417]) === x__$1))
{(links_13418[i_13417] = (x__$1.forward[i_13417]));
{
var G__13419 = (i_13417 + 1);
i_13417 = G__13419;
continue;
}
} else
{{
var G__13420 = (i_13417 + 1);
i_13417 = G__13420;
continue;
}
}
