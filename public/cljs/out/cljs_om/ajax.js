...
cljs_om.ajax.json_xhr = (function json_xhr(p__34006){var map__34008 = p__34006;var map__34008__$1 = ((cljs.core.seq_QMARK_.call(null,map__34008))?cljs.core.apply.call(null,cljs.core.hash_map,map__34008):map__34008);var on_complete = cljs.core.get.call(null,map__34008__$1,new cljs.core.Keyword(null,"on-complete","on-complete",2943599833));var data = cljs.core.get.call(null,map__34008__$1,new cljs.core.Keyword(null,"data","data",1016980252));var url = cljs.core.get.call(null,map__34008__$1,new cljs.core.Keyword(null,"url","url",1014020321));var method = cljs.core.get.call(null,map__34008__$1,new cljs.core.Keyword(null,"method","method",4231316563));var xhr = (new goog.net.XhrIo());goog.events.listen(xhr,goog.net.EventType.COMPLETE,((function (xhr,map__34008,map__34008__$1,on_complete,data,url,method){
return (function (e){return on_complete.call(null,xhr.getResponseText());
});})(xhr,map__34008,map__34008__$1,on_complete,data,url,method))
);
...
cljs_om.ajax.prev_search = (function prev_search(query_string,size,from,chan){return cljs_om.ajax.json_xhr.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"method","method",4231316563),new cljs.core.Keyword(null,"post","post",1017351186),new cljs.core.Keyword(null,"url","url",1014020321),"/tweets/search",new cljs.core.Keyword(null,"data","data",1016980252),cljs_om.ajax.query.call(null,"*",size,from),new cljs.core.Keyword(null,"on-complete","on-complete",2943599833),(function (p1__34009_SHARP_){return cljs.core.async.put_BANG_.call(null,chan,p1__34009_SHARP_);
})], null));
});
