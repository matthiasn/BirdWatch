...
{var pred__14045 = cljs.core._EQ_;var expr__14046 = limit;if(cljs.core.truth_(pred__14045.call(null,1,expr__14046)))
...
{var ch = s.charAt(index);var temp__4124__auto___14052 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___14052))
{var replacement_14053 = temp__4124__auto___14052;buffer.append([cljs.core.str(replacement_14053)].join(''));
} else
{buffer.append(ch);
}
{
